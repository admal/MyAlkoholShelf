...
{
    [HtmlTargetElement("asf:modal")]
    [RestrictChildren("asf:modal-body", "asf:modal-footer")]
    public class AsfModalTagHelper : TagHelper
    {
        /// <summary>
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            context.Items.Add(typeof(AsfModalTagHelper), modalContext);
